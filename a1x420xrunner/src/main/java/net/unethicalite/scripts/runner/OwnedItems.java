...
public class OwnedItems {
    ...
    public static int getCount(int id) {
        if (Bank.isOpen()) {
            BankCache.update();
            return Bank.Inventory.getCount(true,id) + BankCache.getCount(id) + Equipment.getCount(true,id);
        } else {
            return Inventory.getCount(true,id) + BankCache.getCount(id) + Equipment.getCount(true,id);
        }
    }
}
