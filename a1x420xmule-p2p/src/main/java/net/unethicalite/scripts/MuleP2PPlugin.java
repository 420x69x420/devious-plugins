...
@Slf4j
@PluginDescriptor(name = "420xMuleP2P", enabledByDefault = false)
@Extension
public class MuleP2PPlugin extends Script implements PluginInterface {
    ...
    //default configurations that API always needs from script
    @Override
